...
namespace WebApplication1.Controllers
{
    public class DegreesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,DegreeAbv,DegreeName,NumberOfTerms")] Degree degree)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,DegreeAbv,DegreeName,NumberOfTerms")] Degree degree)
        {
            if (id != degree.ID)
            {
                return NotFound();
