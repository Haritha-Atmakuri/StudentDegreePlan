...
namespace WebApplication1.Controllers
{
    public class StudentTermsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentTermID,Term,TermAbbr,TermName,NoOfCoursesTaken,StudentID,DegreePlanID")] StudentTerm studentTerm)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentTermID,Term,TermAbbr,TermName,NoOfCoursesTaken,StudentID,DegreePlanID")] StudentTerm studentTerm)
        {
